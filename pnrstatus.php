...
{
$pnr=$_POST['pnr'];
$sql = "SELECT * FROM user_info WHERE user_id= '$pnr'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
	if($row==NULL)	echo "<script type='text/javascript'>alert('Booking ID not found');</script>";
	else echo "<script type='text/javascript'>alert('Your Train No is ' +'$row[t_no]');</script>";	
}
if (isset($_POST['cancel']))
{
$pnr=$_POST['pnr'];
$sql = "DELETE FROM user_info WHERE user_id=$pnr;";
...
<center>
	...
	<div id="pnrtext"><input type="text" name="pnr" size="30" maxlength="10" placeholder="Enter Book_id here"></div>
	<br/><br/>
