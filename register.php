...
$pw=$_POST['pw'];
$cpw=$_POST['cpw'];
$sql = "INSERT INTO user_info (FName, LName, Age, PhoneNo, Gender, email, password) VALUES ('$fname', '$lname', '$age', '$mob', '$gender', '$email', '$pw');";
...
<HTML>
<HEAD>
<TITLE>Register User on Pakistan Railways</TITLE>
