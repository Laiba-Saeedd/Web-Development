...
$email=$_POST['email'];
$pw=$_POST['pw'];
$sql = "SELECT * FROM admin_info WHERE email = '$email' AND password = '$pw';";
...
<body>
	...
	<div id="loginarea">
	<form id="login" action="loginadmin.php" onsubmit="return validate()" method="post" name="login">
	<div id="logintext">Login as Admin to Pakistan Railways!</div><br/><br/>
	<table>
